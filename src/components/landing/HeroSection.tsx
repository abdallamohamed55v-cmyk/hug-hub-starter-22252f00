...
const HeroSection = () => {
  ...
  return (
    <section className="relative flex min-h-[auto] flex-col items-center overflow-hidden bg-background pt-28 pb-0 md:min-h-screen md:pt-24">
      <div className="relative z-30 mx-auto w-full px-4 text-center">
        ...
        >
          ...
          <button
            ...
            className="rounded-full bg-white px-8 py-3 text-sm font-semibold text-black transition-all hover:scale-[1.03] hover:bg-white/90 md:px-10 md:py-[18px] md:text-base"
          >
            {hero.ctaSecondary}
          </button>
        </motion.div>
