    ...
    <section className="py-20 px-4 relative">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10 px-6 py-24 md:py-36 text-center">
            <h2 className="font-display text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight text-white leading-[0.95] drop-shadow-2xl">
              Affiliate Rewards,
              <br />
              Your Rules
            </h2>
            <p className="mt-8 max-w-2xl mx-auto text-base md:text-lg text-white/90 leading-relaxed drop-shadow-lg">
