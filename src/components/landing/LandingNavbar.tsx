                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          backdropFilter: "blur(200px) saturate(240%)",
                          WebkitBackdropFilter: "blur(200px) saturate(240%)",
                          border: "1px solid rgba(255,255,255,0.1)",
                          boxShadow:
                            "inset 0 1px 0 rgba(255,255,255,0.18), inset 0 -1px 0 rgba(0,0,0,0.3), 0 24px 60px rgba(0,0,0,0.45)",
                        }}
                      >
