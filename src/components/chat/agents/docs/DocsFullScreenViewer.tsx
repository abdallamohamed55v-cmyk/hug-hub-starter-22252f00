  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0 }}
      >
        {/* Header — matches slides presenter */}
        <header className="flex items-center justify-between px-4 py-3 shrink-0">
          ...
          <div className="flex items-center gap-1.5">
            <button
              onClick={handlePrint}
              className="h-9 px-3 rounded-full bg-white/10 hover:bg-white/20 text-white inline-flex items-center gap-1.5 text-[12.5px] font-medium"
              aria-label="Print"
            >
            ...
            {onDownloadPdf && (
              <button
                ...
                className="h-9 px-3 rounded-full bg-white text-black inline-flex items-center gap-1.5 text-[12.5px] font-semibold hover:opacity-90"
