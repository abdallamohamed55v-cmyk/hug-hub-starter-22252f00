...
import { Maximize2, Download, Printer, FileText, FileCode2, Loader2 } from "lucide-react";
    ...
    <>
      <div className="mt-3 rounded-2xl overflow-hidden border border-border/40 bg-card max-w-xl">
        ...
        >
          {html ? (
            <>
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-5 bg-gradient-to-t from-background via-background/85 to-transparent">
                ...
                <h3 className="text-base md:text-lg font-extrabold line-clamp-2 text-foreground">
                  {title}
                </h3>
              </div>
              {/* Hover "Open" badge */}
        ...
        <div className="flex items-center justify-between px-3 py-2 border-t border-border/40 bg-background/40 gap-2">
          <div className="text-xs text-muted-foreground truncate min-w-0 capitalize">
            {docType || "document"}
          </div>
