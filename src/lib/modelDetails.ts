...
const LOGO = {
  ...
  bfl: "/model-logos/bfl.png",
  bytedance: "/model-logos/bytedance.ico",
  ideogram: "/model-logos/ideogram.png",
  kling: "/model-logos/kling.png",
  luma: "/model-logos/luma.png",
  pika: "/model-logos/pika.png",
  recraft: "/model-logos/recraft.png",
  nanoBanana: "/model-logos/nano-banana.jpg",
  megsy: "/model-logos/megsy.png",
  minimax: "/model-logos/minimax.png",
  runway: "/model-logos/runway.png",
  qwen: "/model-logos/qwen.png",
  hidream: "/model-logos/hidream.png",
  stability: "/model-logos/stability.png",
  playground: "/model-logos/playground.png",
  lightricks: "/model-logos/lightricks.png",
} as const;
...
export const ALL_MODEL_DETAILS: ModelDetail[] = [
  ...
  // ═══════════════════════════════════════════
  // FREE IMAGE MODELS (deapi.ai — top 2 only)
  // ═══════════════════════════════════════════
  {
    id: "flux2-klein-4b", name: "FLUX.2 Klein 4B", type: "image", credits: 1,
    description: "Fast, lightweight text-to-image. Free for all users.",
    longDescription: "FLUX.2 Klein 4B BF16 — a compact yet powerful text-to-image model from deapi.ai, optimized for speed and quality at near-zero cost.",
    ...
    iconUrl: LOGO.bfl, badges: ["FREE", "FAST"],
  },
  {
    id: "qwen-image-edit-plus", name: "Qwen Image Edit Plus", type: "image", credits: 1,
    description: "AI image editing and transformation. Free for all users.",
    longDescription: "Qwen Image Edit Plus — upload an image and describe how you want it changed. Best free image-to-image editor on deapi.",
    ...
    iconUrl: LOGO.qwen, badges: ["FREE", "IMG2IMG"],
  },
  // ═══════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════
  {
    ...
    iconUrl: LOGO.lightricks, badges: ["FREE"],
  },
  {
    ...
    provider: "deapi", speed: "standard", quality: "standard", isFree: true,
    iconUrl: LOGO.lightricks, badges: ["FREE", "IMG2VID"],
  },

  // ═══════════════════════════════════════════
  // MEGSY IMAGE — Powered by Nano Banana
  // ═══════════════════════════════════════════
  {
    id: "megsy-image", name: "Megsy Image", type: "image", credits: 4,
    description: "Megsy's signature image model — powered by Nano Banana (Gemini Image).",
    longDescription: "Megsy Image is our flagship image generator: a tuned pipeline on top of Google's Nano Banana (Gemini 2.5 Flash Image) via fal.ai. Generates and edits images from text or up to 4 reference images.",
    icon: "Sparkles", modes: ["text-to-image", "image-to-image"], acceptsImages: true, requiresImage: false, maxImages: 4, acceptedMimeTypes: MIME_IMG,
    provider: "Megsy", speed: "fast", quality: "ultra",
    iconUrl: LOGO.megsy, badges: ["MEGSY", "FLAGSHIP", "EDIT"],
  },
  ...
  {
    id: "fal-ai/nano-banana-2/edit", name: "Nano Banana 2 Edit", type: "image", credits: 6,
    description: "Edit existing images with Gemini 3 Pro Image.",
    longDescription: "Targeted edits on one or more input images using natural language. Highest-fidelity Nano Banana editor.",
    icon: "Image", modes: ["image-to-image"], acceptsImages: true, requiresImage: true, maxImages: 6, acceptedMimeTypes: MIME_IMG,
    provider: "fal", speed: "fast", quality: "ultra",
    iconUrl: LOGO.nanoBanana, badges: ["NEW", "EDIT"],
  },
  {
  ...
  {
    id: "fal-ai/nano-banana/edit", name: "Nano Banana Edit", type: "image", credits: 4,
    description: "Edit existing images with natural-language instructions.",
    longDescription: "Nano Banana Edit takes one or more input images and a prompt to produce a targeted edit.",
    icon: "Image", modes: ["image-to-image"], acceptsImages: true, requiresImage: true, maxImages: 4, acceptedMimeTypes: MIME_IMG,
    provider: "fal", speed: "fast", quality: "high",
    iconUrl: LOGO.nanoBanana, badges: ["EDIT"],
  },
  {
  ...
  {
    id: "fal-ai/bytedance/seedream/v4/edit", name: "Seedream 4.0 Edit", type: "image", credits: 5,
    description: "ByteDance Seedream 4 image editor.",
    longDescription: "Edit images with Seedream 4 — strong identity preservation and natural blending.",
    icon: "Image", modes: ["image-to-image"], acceptsImages: true, requiresImage: true, maxImages: 4, acceptedMimeTypes: MIME_IMG,
    provider: "fal", speed: "standard", quality: "ultra",
    iconUrl: LOGO.bytedance, badges: ["EDIT"],
  },
  {
  ...
  {
    id: "fal-ai/wan/v2.5/text-to-video", name: "Wan 2.5", type: "video", credits: 10,
  ...
  {
    id: "fal-ai/wan/v2.5/image-to-video", name: "Wan 2.5 I2V", type: "video-i2v", credits: 10,
  ...
  {
    id: "fal-ai/runway-gen4/turbo/image-to-video", name: "Runway Gen-4 Turbo I2V", type: "video-i2v", credits: 22,
    description: "Runway Gen-4 Turbo — fast image-to-video with great realism.",
    longDescription: "Runway Gen-4 Turbo image-to-video produces sharp, realistic motion at low latency.",
    icon: "Video", modes: ["image-to-video"], acceptsImages: true, requiresImage: true, maxImages: 1, acceptedMimeTypes: MIME_IMG,
    provider: "fal", speed: "standard", quality: "ultra",
    iconUrl: LOGO.runway, badges: ["IMG2VID", "TURBO"],
  },
  {
    id: "fal-ai/ltx-video-2/text-to-video", name: "LTX Video 2", type: "video", credits: 6,
    description: "Lightricks LTX Video 2 — open, fast, affordable.",
    longDescription: "LTX Video 2 from Lightricks — fast open video model with solid quality.",
    icon: "Video", modes: ["text-to-video"], acceptsImages: false, requiresImage: false, maxImages: 0, acceptedMimeTypes: [],
    provider: "fal", speed: "fast", quality: "high",
    iconUrl: LOGO.lightricks, badges: ["OPEN", "CHEAP"],
  },
  {
