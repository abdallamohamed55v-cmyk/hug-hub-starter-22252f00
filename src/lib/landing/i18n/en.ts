...
const en: LandingContent = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What plans are available?", a: "Starter ($25/mo · 250 MC), Pro ($49/mo · 500 MC, API + social publishing) and Elite ($149/mo · 1,500 MC, webhooks + dedicated support). All plans cover commercial use, image & video gen, code, and GitHub sync." },
