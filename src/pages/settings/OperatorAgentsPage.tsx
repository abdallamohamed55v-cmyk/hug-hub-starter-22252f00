    ...
    <div className="h-[100dvh] bg-background overflow-y-auto">
      <div className="max-w-lg mx-auto pb-16 px-5">
        <div className="flex items-center justify-between py-4">
          ...
          <h1 className="font-display text-base font-bold">الوكلاء الديناميكيون</h1>
          <div className="w-9" />
        </div>

        <p className="text-xs text-muted-foreground mb-4 px-1">
          الوكلاء المتخصصون اللي ولّدهم الذكاء تلقائياً لمهامك. كل وكيل بيتفعّل لما يلاقي مهمة في تخصصه.
        </p>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-muted-foreground text-sm">
            ...
            لا يوجد وكلاء بعد. اطلب من الذكاء مهمة متخصصة وسيُولّد وكيلاً مناسباً.
          </div>
        ) : (
              ...
              <div key={a.id} className="p-4 rounded-2xl bg-muted/30 border border-border/30 flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-muted-foreground/70 mt-1.5">
                    استخدم {a.usage_count} مرة · {new Date(a.created_at).toLocaleDateString("ar")}
                  </p>
                </div>
