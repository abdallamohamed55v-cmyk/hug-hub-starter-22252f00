...
const VIDEO_TOOLS_LIST: Tool[] = [
  { id: "swap-characters", name: "Swap", route: "/videos/tools/swap-characters", Icon: ToolFacesIcon, desc: "Face swap in video" },
  ...
  { id: "video-colorizer", name: "Colorize", route: "/videos/tools/video-colorizer", Icon: ToolPaletteIcon, desc: "Color old videos" },
  { id: "video-watermark", name: "Watermark", route: "/videos/tools/video-watermark", Icon: ToolWatermarkIcon, desc: "Remove watermarks" },
  { id: "video-bg-replacer", name: "BG Replace", route: "/videos/tools/video-bg-replacer", Icon: ToolEraseIcon, desc: "Swap backgrounds" },
  { id: "video-intro", name: "Intro", route: "/videos/tools/video-intro", Icon: ToolFilmIcon, desc: "Cinematic intros" },
  { id: "video-denoise", name: "Denoise", route: "/videos/tools/video-denoise", Icon: ToolNoiseIcon, desc: "Clean noise & grain" },
    ...
    >
      <div className="relative aspect-[4/5] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 p-3">
          <div className="text-[13.5px] font-semibold text-white leading-tight">{tool.name}</div>
          <div className="text-[11px] text-white/75 leading-snug mt-0.5 line-clamp-2">{tool.desc}</div>
        </div>
      </div>
    </motion.button>
  );
  ...
  return (
    <div className="h-[100dvh] flex bg-[#f6f6f4] md:bg-background overflow-hidden">
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 w-[120vw] h-[60vh] rounded-full opacity-40 blur-[120px]"
          style={{
            background:
            ...
            <>
              ...
              <div className="mt-10 px-4 md:mt-20 md:px-2">
                ...
                {showcase.length === 0 ? (
                  ...
                  <>
                    {/* Mobile: horizontal scroll */}
                    <div className="flex gap-2.5 overflow-x-auto overflow-y-visible scrollbar-hide snap-x -mx-4 px-4 pb-2 md:hidden">
                      {showcase.slice(0, 12).map((it) => (
                        <motion.button
                          key={it.id}
                        ...
                        >
                          {it.media_type === "video" ? (
                            <video src={(it as any).media_url} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.06]" muted playsInline />
                          ) : (
                            <CachedMediaImage src={(it as any).media_url} alt="" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.06]" loading="eager" decoding="async" />
                          )}
                          {it.media_type === "video" && (
                            <span className="absolute top-2 left-2 w-6 h-6 rounded-full flex items-center justify-center bg-black/55 backdrop-blur-md text-white text-[9px] font-bold">▶</span>
                          )}
                        </motion.button>
                      ))}
                    ...
                    {studioItems.map((it: any, i) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className="relative w-full aspect-[3/4] rounded-2xl overflow-hidden bg-black/30 border border-foreground/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] block"
                        >
                          {isVid ? (
                            <>
                            ...
                            <CachedMediaImage src={it.url} alt="" className="w-full h-full object-cover" loading="eager" decoding="async" />
                          )}
                        </motion.button>
                      );
                    })}
                              ...
                              {section.items.map((it) => (
                                <div key={it.id} className="relative w-full aspect-[3/4] rounded-2xl overflow-hidden bg-muted group">
                                  ...
                                  >
                                    ...
                                    {it.media_type === "video" && (
                                      <span className="absolute top-2 left-2 w-7 h-7 rounded-full flex items-center justify-center bg-black/40 backdrop-blur-md text-white text-[10px] font-bold">▶</span>
                                    )}
                                  </button>
                                </div>
                              ))}
        ...
        <div className="md:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-30">
          <div className="flex items-center gap-1 p-1.5 rounded-full bg-zinc-900/70 backdrop-blur-3xl backdrop-saturate-200 border border-foreground/20 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.25),inset_0_-1px_0_0_rgba(255,255,255,0.05),0_20px_50px_-15px_rgba(0,0,0,0.6)]">
            {[
