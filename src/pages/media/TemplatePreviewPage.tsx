    ...
    <div className="fixed inset-0 z-50 bg-black flex flex-col">
      ...
      <header className="absolute top-0 inset-x-0 z-20 flex items-center justify-between px-4 pt-4 pb-3 bg-gradient-to-b from-black/70 via-black/30 to-transparent">
        <button
          ...
          className="w-10 h-10 rounded-full flex items-center justify-center bg-white/10 backdrop-blur-2xl border border-white/15 text-white active:scale-95 transition"
          aria-label="Back"
        >
          ...
          <div className="absolute bottom-0 inset-x-0 z-20 px-4 pt-10 pb-6 bg-gradient-to-t from-black via-black/85 to-transparent">
            <div className="max-w-[560px] mx-auto">
              <button
                ...
                className="w-full h-14 rounded-2xl bg-white text-black font-semibold text-[15px] flex items-center justify-center gap-2 active:scale-[0.98] transition shadow-[0_20px_50px_-10px_rgba(255,255,255,0.25)]"
              >
                Use this template
              </button>
